...
CFLAGS += -DFFTGRAPH_EXPORTS -D_USRDLL -DMINGW_HAS_SECURE_API -DUNICODE -D_UNICODE -DNO_STRICT -DCMAKE_INTDIR=\"Release\"   
...
SOURCES := fftsg.c Main.cpp ../tp_stub.cpp
OBJECTS := $(SOURCES:.c=.o)
